...
def export_blacklists_to_files():
    ...
    try:
        ...
        # Also generate dnsmasq blocklist for DNS blackhole (L3 blocking)
        with open('/config/dnsmasq-blocklist.conf', 'w') as f:
            ...
            for d in domains:
                ...
                if d and not d.startswith('#'):
                    ...
                    f.write(f"address=/{d}/::\n")
        logger.info(f"DNS blocklist generated: {len(domains)} domains")
